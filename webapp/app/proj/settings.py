...
SECRET_KEY = (
    "django-insecure-p65w!p&d!6+=xu*(4*i=y4)8cc4vqgya2)k96^$@)d%6pn23w2"
)
...
CONSTANCE_CONFIG = {
    ...
    "EMAIL_SEND_TIME": (time(hour=2, minute=30), "Время отправки"),
    "WEATHER_FETCH_FREQUENCY": (
        1,
        "Периодичность получения сводок погоды (в часах)",
    ),
}
